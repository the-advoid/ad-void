...
Scriptlets are an advanced topic and are supported in only a few ad-blockers, most notably in system-wide ad-blockers; ad-blockers that work outside browsers as well. [AdGuard](https://adguard.com?aid=135952) being one of the most used system-wide ad-blocker that supports them.
