...
Badges were created using the [Custom Icon Badges](https://github.com/DenverCoder1/custom-icon-badges), specifically, its service available at [custom-icon-badges.demolab.com](https://custom-icon-badges.demolab.com).
