...
Try going through the archive of <a href="https://github.com/the-advoid/ad-void/tree/main/legacy/add-ons"><strong>legacy AdVoid add-ons</strong></a> for filter rules that were deprecated and removed from the main filter lists.  
